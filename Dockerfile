...
LABEL Description="RabbitMQ" Vendor="Pivotal" Version="3.7.12"
...
RUN [Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12; \
    Invoke-WebRequest -Uri "http://www.erlang.org/download/otp_win64_21.2.exe" -OutFile "c:\\erlang_install.exe" ; \
